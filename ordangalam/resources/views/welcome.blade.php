...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active">
      <img class="d-block w-100" src="{{URL::asset('/image/slide3.jpg')}}" alt="First slide">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="{{URL::asset('/image/slide1.jpg')}}" alt="Second slide"> 
      <div class="carousel-caption d-none d-md-block">
    <h5>CAPTION 2</h5>
    <p>blablalaba</p>
  </div>
    ...
    <div class="carousel-item ">
      <img class="d-block w-100" src="{{URL::asset('/image/slide2.jpg')}}"alt="Third slide">
      <div class="carousel-caption d-none d-md-block">
    <h5>CAPTION 3</h5>
    <p>blablabla</p>
  </div>
